...
HI，您好，欢迎使用高重AI开放平台视频识别 API接口服务。

| 本文档主要针对需要集成HTTP API的技术研发工程师，详细描述视频识别能力相关的技术内容。
...
============ ========================= =======================================================
  接口名称    		接口描述       							API地址
============ ========================= =======================================================
 视频识别      识别视频上的字段信息       https://openai.grandhonor.net/api/invoice/ocr
============ ========================= =======================================================
